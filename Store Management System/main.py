import datetime
import random
from tkinter import *  #helps in making GUI based application..that is frontend of an application
import sqlite3
...
labels_list = []
class Application:
    def __init__(self, master, *args, **kwargs):   #*args allows you to do is take in more arguments than the number of
        # formal arguments that you previously defined.
        #**kwargs with the double star allows us to pass through keyword arguments (and any number of them).
        self.master = master  #parent used to represent the parent window
